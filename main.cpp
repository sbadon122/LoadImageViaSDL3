...
// Function to load an image and return an SDL_Texture
...
SDL_AppResult SDL_AppIterate(void *appstate)
{
    ...
    std::string path = "dog.png";


    SDL_Texture* texture = LoadImage(renderer, path);
    if (!texture) {
        return SDL_APP_FAILURE; // Exit if the texture fails to load
    }
